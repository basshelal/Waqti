...
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.AMBER
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.BLUE
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.BLUE_GREY
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.BROWN
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.CYAN
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.DEEP_ORANGE
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.DEEP_PURPLE
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.GREEN
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.GREY
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.INDIGO
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.LIGHT_BLUE
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.LIGHT_GREEN
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.LIME
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.ORANGE
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.PINK
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.PURPLE
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.RED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.TEAL
import uk.whitecrescent.waqti.frontend.appearance.MaterialColor.YELLOW
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.EIGHT_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.FIFTY
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.FIVE_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.FOUR_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.NINE_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.ONE_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.SEVEN_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.SIX_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.THREE_HUNDRED
import uk.whitecrescent.waqti.frontend.appearance.MaterialColorLevel.TWO_HUNDRED
...
fun getMaterialColors(materialColor: MaterialColor): List<WaqtiColor> {
    return when (materialColor) {
...
fun getMaterialColors(materialColorLevel: MaterialColorLevel): List<WaqtiColor> {
...
fun getMaterialColor(materialColor: MaterialColor, materialColorLevel: MaterialColorLevel): WaqtiColor {
    return getMaterialColors(materialColor).intersect(getMaterialColors(materialColorLevel)).first()
}
