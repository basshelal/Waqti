//package uk.whitecrescent.waqti.android.customview.java;
//
...
//    private ListSwipeItem.SwipeState mSwipeState = ListSwipeItem.SwipeState.IDLE;
...
//    private ListSwipeItem.SwipeDirection mSwipeDirection = ListSwipeItem.SwipeDirection.LEFT_AND_RIGHT;
//    private ListSwipeItem.SwipeInStyle mSwipeInStyle = ListSwipeItem.SwipeInStyle.APPEAR;
//
...
//    }
//
//    public void setSwipeInStyle(ListSwipeItem.SwipeInStyle style) {
//        mSwipeInStyle = style;
//    }
//
//    public void setSupportedSwipeDirection(ListSwipeItem.SwipeDirection swipeDirection) {
//        mSwipeDirection = swipeDirection;
//    }
//
//    public ListSwipeItem.SwipeDirection getSupportedSwipeDirection() {
...
//    }
//
//    ListSwipeItem.SwipeDirection getSwipedDirection() {
//        if (mSwipeState != ListSwipeItem.SwipeState.IDLE) {
//            return ListSwipeItem.SwipeDirection.NONE;
//        }
//
//        if (mSwipeView.getTranslationX() == -getMeasuredWidth()) {
//            return ListSwipeItem.SwipeDirection.LEFT;
//        } else if (mSwipeView.getTranslationX() == getMeasuredWidth()) {
//            return ListSwipeItem.SwipeDirection.RIGHT;
//        }
//        return ListSwipeItem.SwipeDirection.NONE;
//    }
//
//    boolean isAnimating() {
//        return mSwipeState == ListSwipeItem.SwipeState.ANIMATING;
//    }
//
...
//        if ((mSwipeDirection == SwipeDirection.LEFT && x > 0) || (mSwipeDirection == ListSwipeItem.SwipeDirection.RIGHT && x < 0) || mSwipeDirection == ListSwipeItem.SwipeDirection.NONE) {
//            x = 0;
//        }
//
...
//            if (mSwipeInStyle == ListSwipeItem.SwipeInStyle.SLIDE) {
...
//        }
//
//        mSwipeState = ListSwipeItem.SwipeState.ANIMATING;
...
//                        mSwipeState = ListSwipeItem.SwipeState.IDLE;
//                        mSwipeListener = null;
//                    }
//                });
//            } else {
...
//            return;
//        }
//        mSwipeState = ListSwipeItem.SwipeState.SWIPING;
//        if (!mSwipeStarted) {
//            mSwipeStarted = true;
